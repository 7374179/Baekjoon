...
public class a099_2162 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i=1;i<=N;i++){
            ...
            for(int j=1; j<i;j++){
                if(isCross1(L[i][0], L[i][1], L[i][2], L[i][3], L[j][0], L[j][1], L[j][2], L[j][3])==true){
                    union1(i, j);
                }
            }
        }
    ...
    private static boolean isCross1(long x1, long y1, long x2, long y2, long x3, long y3, long x4, long y4){
